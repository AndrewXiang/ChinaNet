				...
				<TBODY>
					...
					<TR vAlign=top>
						<TD height="600" bgColor=#f1f3f9>
							...
							<form method="POST" action="../editCharge.action">
								<p>
									收费项目：
									<select size="1" name="chargeCode">
										<option value="A">
											开户费
										</option>
										<option value="B">
								...
								<p>
									收费金额：
									<input type="text" name="charge" size="20" value="10">
								</p>
								<p>
							...
							<form method="POST" action="../editChargeRule.action">
								<p>
									业务：
									<select size="1" name="rule">
										<option value="O">
											开户业务
										</option>
									</select>
								...
								<p>
									...
									押金
									<input type="checkbox" name="item" value="D" checked>
									入网费
									<input type="checkbox" name="item" value="E" checked>
									选号费
								</p>
								<p>
									<input type="submit" value="提交" name="B1">
