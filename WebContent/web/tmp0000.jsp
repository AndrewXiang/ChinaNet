		...
		<CENTER>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            ...
            href="modifyOperator.htm">修改操作员</A></TD>
									...
									<TR>
										<TD bgColor=#ffffff colSpan=2>
											<IMG height=1 src="中国移动通信.files/blank.gif" width=1 border=0>
										</TD>
									</TR>
									<TR>
						...
						<TD height="600" bgColor=#f1f3f9>
							...
							<form method="POST" action="../saveInfo.jsp">
								...
								<p>
									...
									国内漫游
									<input type="radio" name="R1" value="V6">
									国际漫游
								</p>
								<p>
									通话级别：
									<input type="radio" value="V1" checked name="R2">
									本地通话
								...
								<p>
									客户ID：
									<input type="text" name="T2" size="20" value="11100011"
										readonly>
								</p>
